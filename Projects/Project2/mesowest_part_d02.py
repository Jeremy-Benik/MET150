...
ax.set_title('Temperature (Observations vs. Wrfout file) d02', fontsize = 18, fontweight = 'bold')
...
ax.set_xlabel('Time (UTC)', fontsize = 12, fontweight = 'bold')
ax.set_title('U Wind (Observations vs. Wrfout file) d02', fontsize = 18, fontweight = 'bold')
ax.tick_params(axis='both', labelsize=10)
ax.set_xlim(df1[0], df1[-1])
ax.legend()
ax.grid()
...
ax.set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax.set_xlabel('Time (UTC)', fontsize = 12, fontweight = 'bold')
ax.set_title('V Wind (Observations vs. Wrfout file) d02', fontsize = 18, fontweight = 'bold')
ax.tick_params(axis='both', labelsize=10)
ax.set_xlim(df1[0], df1[-1])
ax.legend()
ax.grid()
...
ax.set_xlabel('Time (UTC)', fontsize = 12, fontweight = 'bold')
ax.set_title('Accumulated Precipitation (mm) (Observations vs. Wrfout file) d02', fontsize = 18, fontweight = 'bold')
ax.tick_params(axis='both', labelsize=10)
ax.set_xlim(df1[0], df1[-1])
ax.legend()
ax.grid()
